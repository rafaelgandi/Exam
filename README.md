...
PS how to hide guides
=====================
<p>
	Hide all the guides by selecting "View" from the top menu bar, followed by "Show" and "Guides." 
	This hides all the guides.
